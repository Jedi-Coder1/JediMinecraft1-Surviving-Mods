...
local display_icon = CurrentModPath .. "UI/rover.png"

DefineClass.RCScrubber = {
	__parents = {
		"BaseRover",
		"ComponentAttach",
	},
...
function RCScrubber:SetCommand(command, ...)
...
function RCScrubber:Getui_command()
	return self.status_text
end

function RCScrubber:GotoFromUser(...)
	self.status_text = T(63, "Travelling")
	return BaseRover.GotoFromUser(self, ...)
end

-- for auto mode
function RCScrubber:ProcAutomation()
